...
func TestGitStatus_WatcherStillReturnsAccurateLocalState(t *testing.T) {
	...
	dirty, _, _, _, _, _, _, _, _, _, _, currentBranch, _ := m.gitStatus(ctx, "ws-test", RefreshTriggerWatcher, cloneDir, remoteDir)
...
func TestGitStatus_ReturnsCurrentBranch(t *testing.T) {
	...
	// On main branch
	_, _, _, _, _, _, _, _, _, _, _, branch, _ := m.gitStatus(ctx, "ws-test", RefreshTriggerExplicit, cloneDir, remoteDir)
	if branch != "main" {
...
func TestGitStatus_FilesChangedCountsUntrackedFilesInNewDirs(t *testing.T) {
	...
	_, _, _, _, _, filesChanged, _, _, _, _, _, _, _ := m.gitStatus(ctx, "ws-test", RefreshTriggerExplicit, cloneDir, remoteDir)
...
func TestCommitsSyncedWithRemote_DerivedFromRevList(t *testing.T) {
	...
	_, _, _, _, _, _, commitsSynced, remoteBranchExists, _, _, _, _, _ := m.gitStatus(ctx, "ws-test", RefreshTriggerExplicit, cloneDir, remoteDir)
...
func TestCommitsSyncedWithRemote_FalseWhenAhead(t *testing.T) {
	...
	_, _, _, _, _, _, commitsSynced, _, _, localUnique, _, _, _ := m.gitStatus(ctx, "ws-test", RefreshTriggerExplicit, cloneDir, remoteDir)
	if commitsSynced {
