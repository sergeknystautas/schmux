...
export default function LoreConfig({ state, dispatch, models }: ConfigPanelProps) {
  ...
  return (
    <>
      ...
      <div className="form-group">
        ...
        <p className="form-group__hint">How public lore rules are committed to the repository.</p>
      </div>
    </>
  );
}
