...
describe('LorePage', () => {
      ...
      proposals: [
        {
          ...
          status: 'pending',
          rules: [
            makeRule({ id: 'r1', text: 'Run tests before committing' }),
            makeRule({ id: 'r2', text: 'Format code with prettier' }),
          ],
        },
      ],
    });
  ...
  it('deduplicates rules with same normalized text across proposals', async () => {
      ...
      proposals: [
        {
          ...
          created_at: '2026-04-01T00:00:00Z',
          status: 'pending',
          rules: [makeRule({ id: 'r1', text: 'Run tests  always' })],
        },
        {
          id: 'p2',
          repo: 'test-repo',
          ...
          status: 'pending',
          rules: [makeRule({ id: 'r2', text: 'run tests always' })],
        },
      ],
    });
    ...
    await waitFor(() => {
      expect(screen.getByTestId('lore-page')).toBeInTheDocument();
    });
  ...
  it('approve propagates to duplicates', async () => {
    ...
    mockUpdateLoreRule.mockResolvedValue({
      ...
      created_at: '2026-04-01T00:00:00Z',
      status: 'pending',
      rules: [makeRule({ id: 'r1', text: 'Run tests  always', status: 'approved' })],
    });
