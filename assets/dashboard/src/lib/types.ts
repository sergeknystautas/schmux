...
export interface WorkspaceResponse {
  ...
  default_branch_orphaned?: boolean; // true if origin/default has no common ancestor with HEAD
  ...
  ci_status?: string; // "queued" | "in_progress" | "failure" | "success"; absent when GitHub unavailable, repo has no workflows, or no remote branch
