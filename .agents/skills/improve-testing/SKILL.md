...
description: Run schmux's continuous test-improvement loop to increase meaningful coverage, reduce flakiness, and improve performance. Use only when the user explicitly invokes this skill or asks to run the test-improvement workflow.
---
