---
name: rebase
description: Rebase the current feature branch onto origin/main, resolve conflicts, and verify the result. Use only when the user explicitly invokes this skill or asks to rebase the branch.
---
