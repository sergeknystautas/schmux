---
name: pull
description: Pull remote changes into the current branch, rebasing local commits when needed, then verify the result. Use only when the user explicitly invokes this skill or asks to pull remote changes.
---
