...
a remote profile card, the connection modal opens with an embedded terminal
...
- The spawn page loads and shows a "+ New [profile] host" card with "Provision a new instance"
...
- The modal header shows the profile display name
