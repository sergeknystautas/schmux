...
```json
{"type":"history","protocol":"claude-stream-json","records":[{"ts":"...","type":"user_message","id":"...","text":"...","images":[{"media_type":"image/png","data":"","preview_url":"/api/chat/<sessionId>/images/<messageId>/0","preview_width":1000,"preview_height":800}]}, {"ts":"...","type":"harness","line":{...}}, {"ts":"...","type":"control","line":{...}}]}
{"type":"record","record":{...}}
{"type":"error","message":"..."}
```
