...
- `presets` opt into core-defined bundles with additional capabilities or
  ...
  state dir `~/Library/Application Support/Spine`), `chromium` (macOS Mach lookup/register
