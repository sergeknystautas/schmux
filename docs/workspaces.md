...
| Preset         | Enables                                                                                                                                                                                                                                                   |
| -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `sentry`       | `sentry` PATH shim (`NODE_USE_ENV_PROXY=1`, `SENTRY_CLI_NO_TELEMETRY=1`); allows `sentry.io`, `us.sentry.io`, `de.sentry.io`; macOS: write `~/Library/Caches/io.sentry` and `~/Library/Caches/SentryCrash` (Sentry Cocoa's working dir and crash reports) |
